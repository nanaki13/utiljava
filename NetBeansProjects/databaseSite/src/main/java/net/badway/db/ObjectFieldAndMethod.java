...
class ObjectFieldAndMethod {
    ...
    public ObjectFieldAndMethod() {
    }

    public ObjectFieldAndMethod(List<Annotation> annotations, Field field, Method getter, Method setter, ProvierConvertor pofam) {
